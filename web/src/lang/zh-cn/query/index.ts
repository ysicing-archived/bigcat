...
export default {
      "query.banner.title": "欢迎使用大猫系统",
      "query.banner.sub": "使用前请详细阅读以下注意事项，了解完毕后点击 进入按钮 进入查询页面",
      "query.banner.attion": "注意事项:",
      "query.banner.attion.1": "查询操作将会保存用于日后审计需要",
      "query.banner.attion.2": "已限制最大limit数，如自己输入的limit数大于平台配置的最大limit数则以平台配置的limit数为准",
